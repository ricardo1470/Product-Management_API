...
namespace ProductManagementAPI
{
    public class Startup
    {
        ...
        {
            var dataBaseConnetConfiguration = new DataBaseConfiguration(Configuration.GetConnectionString("DataBaseConnection"));
            services.AddSingleton(dataBaseConnetConfiguration);
